...
export const TopPlacementsCard = ({
  placements
}: TopPlacementsCardProps) => {
  ...
  return <Card className="bg-card border-border">
      ...
      <CardContent className="pt-0 space-y-3">
        {topPlacements.map((placement, index) => <div key={`${placement.platform}-${placement.placement}`} className="space-y-1.5">
