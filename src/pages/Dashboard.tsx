            ...
            <main className="p-4 lg:p-6">
              ...
              <section className="mb-5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                  <StatCard label="Total Clicks" value={displayStats.totalClicks.toLocaleString()} icon={MousePointer} trend={selectedLinkId ? undefined : (clicksTrend ?? undefined)} accentColor="primary" customColor={METRIC_COLORS[activeMetric]} compact tooltip="Total number of times someone clicked on your tracking link. Every visit counts — even repeat visitors." isActive={activeMetric === 'clicks'} onClick={() => handleMetricChange('clicks')} />
